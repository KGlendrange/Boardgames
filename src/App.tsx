...
import { Chat, KEY_CHAT } from "./Menu/Chat/Chat";
    ...
    <div className="App">
      <Routes>
        ...
        <Route
          path="/TicTacToe"
          element={
            <TicTacToe peer={peer} connections={connections} ultimate={false} />
          }
        />
        <Route
          path="/UltimateTicTacToe"
          element={
            <TicTacToe peer={peer} connections={connections} ultimate={true} />
          }
        />
      </Routes>
      <Chat
